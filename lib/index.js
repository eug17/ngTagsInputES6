...
exports.default = _angular2.default.module('ngTagsInput', []).provider('tiUtil', _util2.default).provider('tagsInputConfig', _configuration2.default).directive('autoComplete', _autoComplete2.default).directive('tiAutocompleteMatch', _autoCompleteMatch2.default).directive('tiAutosize', _autosize2.default).directive('tiBindAttrs', _bindAttrs2.default).directive('tiTagItem', _tagItem2.default).directive('tagsInput', _tagsInput2.default).directive('tiTranscludeAppend', _transcludeAppend2.default);